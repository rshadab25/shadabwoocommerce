(function ($) {
    ...
    var defaultButtonTabsFilter = function() {
        var self = this;
        var switchParams = function(val) {
            var $designOptionsTab = self.$tabsMenu.find('.vc_edit-form-tab-control[data-tab-index="1"]');
             var $designOptionsTabLink = self.$tabsMenu.find('.vc_edit-form-tab-control[data-tab-index="2"]');
