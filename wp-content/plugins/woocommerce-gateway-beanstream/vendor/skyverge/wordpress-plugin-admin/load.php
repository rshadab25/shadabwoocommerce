...
if ( ! function_exists( 'sv_wordpress_admin_initialize_1_0_0' ) ) {
	...
	// register v1.0.0
	\SkyVerge\WordPress\Plugin_Admin\Versions::register( '1.0.0', 'sv_wordpress_admin_initialize_1_0_0' );

	/**
	 * Initializes the WordPress Admin package v1.0.0.
	 *
	 * This function should not be called directly.
	 *
	 * @since 1.0.0
	 */
	function sv_wordpress_admin_initialize_1_0_0() {
