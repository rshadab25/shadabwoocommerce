...
class WPMUDEV_Dashboard_Sui_Page_Urls {
	...
	public function __construct() {
		...
		$this->documentation_url    = array(
			...
			'analytics'     => $this->remote_site . 'docs/wpmu-dev-plugins/wpmu-dev-dashboard-plugin-instructions/#wpmu-dev-dashboard-tools',
			'whitelabel'     => $this->remote_site . 'docs/wpmu-dev-plugins/wpmu-dev-dashboard-plugin-instructions/#wpmu-dev-dashboard-tools',
